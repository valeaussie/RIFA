...
int OpenSph()
{
	...
	string shape;
	const char *filePath = "australia_administrative_boundaries_national_polygon.shp";
	...
	if ((file = fopen(filePath, "rb")) == NULL)
		...
		cout << "Map of Australia opened successfully" << endl;
	...
	cout << "File size get = " << &fileBuf << endl;
